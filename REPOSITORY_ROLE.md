...
|------------|---------------------------|
| **vector-runtime-governance-public** | Public constitutional / orientation entry. Architecture, governance, authority navigation, and portfolio orientation. **Not** the main public technical landing (that is **vector-core**). **Publication does not imply runtime authority or implementation authorization.** |
